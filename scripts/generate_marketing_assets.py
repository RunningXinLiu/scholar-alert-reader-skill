...
<desc id="desc">Scholar Alert Reader 中文宣传架构图：从 Scholar Alert 邮件和 BibTeX/RIS 导入到每日简报、重点阅读、个人知识库、深读问答和 Obsidian/Zotero 导出。</desc>
<defs>
...
<g font-family="PingFang SC, Inter, Arial, sans-serif">
  <rect x="62" y="205" width="302" height="338" rx="24" fill="url(#panel)" stroke="#d8e0ea" filter="url(#shadow)"/>
  ...
  <rect x="92" y="306" width="216" height="46" rx="13" fill="#dbeafe" stroke="#bfdbfe"/>
  <text x="116" y="335" fill="#1d4ed8" font-size="17" font-weight="800">Gmail API</text>
  <rect x="114" y="366" width="216" height="46" rx="13" fill="#dcfce7" stroke="#bbf7d0"/>
  <text x="138" y="395" fill="#047857" font-size="17" font-weight="800">邮件归档</text>
  <rect x="92" y="426" width="216" height="46" rx="13" fill="#fef3c7" stroke="#fde68a"/>
  <text x="116" y="455" fill="#92400e" font-size="17" font-weight="800">Apple Mail</text>
  <rect x="114" y="486" width="216" height="46" rx="13" fill="#ede9fe" stroke="#ddd6fe"/>
  <text x="138" y="515" fill="#6d28d9" font-size="17" font-weight="800">BibTeX / RIS</text>
  <path d="M285 310l32 18 -32 18z" fill="#93c5fd" opacity=".7"/>
  <path d="M307 370l32 18 -32 18z" fill="#86efac" opacity=".7"/>
  <path d="M285 430l32 18 -32 18z" fill="#fcd34d" opacity=".7"/>
  <path d="M307 490l32 18 -32 18z" fill="#c4b5fd" opacity=".7"/>
