...
- Generated personal data, OAuth files, mailbox exports, personal BibTeX/RIS imports, personal feed lists, `reader_out/`, and `knowledge_base/` must not be committed.
