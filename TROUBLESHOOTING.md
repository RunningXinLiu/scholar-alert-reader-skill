...
```bash
python3 scripts/scholar_reader.py source-check --project-dir ~/scholar_alerts --source auto
python3 scripts/scholar_reader.py doctor --profile ~/scholar_alerts/profiles/research_profile.json --kb-dir ~/scholar_alerts/knowledge_base --out-dir ~/scholar_alerts/reader_out/daily --gmail-deps
```
