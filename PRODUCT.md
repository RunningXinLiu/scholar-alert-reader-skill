...
- Main actions: self-test, profile-based ranking, dashboard, feedback UI, scheduled/manual digest, profile-tune, reading-plan, deep-read, workup, full-text, review-workflow, review-pack, review-queue, ask-library, advice, compare, map.
