...
- A new user can run `init-project`, open `START_HERE.html` or read `START_HERE.md`, choose a real source from the source setup matrix, and complete a first run without knowing the internals.
