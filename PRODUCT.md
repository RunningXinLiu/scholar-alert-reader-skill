...
- A user can trigger selected-paper deep-read/full-review/workup/review-pack reports from the local feedback UI, see and filter current feedback/reading-status badges, mark papers as background-only or not-relevant after reading, and open generated markdown reports from local browser links.
