...
- `START_HERE.md` and `START_HERE.html`: local onboarding guide with first-run workflow, source setup matrix, current source readiness hints from local files and `reader.env`, optional integrations, and setup status.
